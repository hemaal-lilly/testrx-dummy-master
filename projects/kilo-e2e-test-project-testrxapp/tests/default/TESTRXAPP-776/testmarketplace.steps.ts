...
When('the page renders', async function () {
  // No additional actions needed, page is already loaded
});
...
When('the hero section is viewed', async function () {
  // No additional actions needed, hero section is already visible
});
...
When('the cards under the {string} section are viewed', async function () {
  // No additional actions needed, cards section is already visible
});
...
When('each displayed card under the {string} section is inspected', async function () {
  // No additional actions needed, cards are already visible
});
