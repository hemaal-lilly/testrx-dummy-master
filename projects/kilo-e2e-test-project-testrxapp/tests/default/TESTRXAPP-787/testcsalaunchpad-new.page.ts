...
export class CsaLaunchpadHomePage {
  ...
  // Locators
  get topHeader() { return this.page.locator('header'); }
  ...
  get myLqs302Card() { return this.page.locator('[data-testid="lqs302-card"]'); }
  get myItAssetsCard() { return this.page.locator('[data-testid="it-assets-card"]'); }
  get cardIcon() { return this.page.locator('[data-testid="card-icon"]'); }
  get cardRightArrow() { return this.page.locator('[data-testid="card-right-arrow"]'); }
  ...
  async expectCardIconVisible(card: Locator): Promise<void> {
    await expect(card.locator(this.cardIcon)).toBeVisible();
  }

  async expectCardRightArrowVisible(card: Locator): Promise<void> {
    await expect(card.locator(this.cardRightArrow)).toBeVisible();
  }
